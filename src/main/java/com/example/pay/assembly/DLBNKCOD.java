...
public class DLBNKCOD {
    ...
    public static Object escapeParamer(String urlStr ,JSONObject jsonobject,String interfacename, String flag) throws Exception {
        ...
        stream.setProvinceName(jsonobject.getString("provinceName"));
        stream.setCityName(jsonobject.getString("cityName"));
        stream.setBankName(jsonobject.getString("bankName"));
        stream.setTgfi(jsonobject.getString("tgfi"));
        stream.setTgname(jsonobject.getString("tgname"));
