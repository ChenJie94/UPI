...
public class LogUtil {
	...
	private final static Logger LOADECITIC=LoggerFactory.getLogger("ECITIC_SDK_LOG");
	private final static Logger LOADECITIC_ERROR=LoggerFactory.getLogger("ECITIC_SDK_ERR_LOG");
	private final static Logger LOADECITIC_MESSAGE=LoggerFactory.getLogger("ECITIC_SDK_MSG_LOG");
